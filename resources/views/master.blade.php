                            ...
                            <nav class="navbar navbar-expand-lg">
                                ...
                                <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                    <ul id="nav" class="navbar-nav ms-auto">
                                        <li class="nav-item">
                                            <a class="page-scroll {{ request()->is('employees*') ? 'active' : '' }}"
                                                href="{{ url('employees/index') }}">Employees</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="page-scroll {{ request()->is('proposal*') ? 'active' : '' }}"
                                                href="{{ url('proposal/index') }}">Proposal</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="page-scroll {{ request()->is('serviceused*') ? 'active' : '' }}"
                                                href="{{ url('serviceused/index') }}">Serviceused</a>
                                        </li>

                                        <li class="nav-item">
                                            <a class="page-scroll {{ request()->is('timesheet*') ? 'active' : '' }}"
